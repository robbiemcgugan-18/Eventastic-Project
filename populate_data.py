...
def generate_data():
    ...
    profile1.profilePicture = ImageFile(open("population_images/profile_images/user1.jpg", 'rb'))
    profile2.profilePicture = ImageFile(open("population_images/profile_images/user2.jpg", 'rb'))
    profile3.profilePicture = ImageFile(open("population_images/profile_images/user3.jpg", 'rb'))
    ...
    aviation_category.picture = ImageFile(open("population_images/category_images/aviation.jpg", 'rb'))
    cooking_category.picture = ImageFile(open("population_images/category_images/cooking.jpg", 'rb'))
    sport_category.picture = ImageFile(open("population_images/category_images/sport.jpg", 'rb'))
